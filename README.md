...
This example code does not provide input datasets and is designed based on the assumption that you have two different CT and PET radiomics feature sets. Input your omics datasets to run this code. 
